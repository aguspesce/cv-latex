...
\begin{cventries}
    \education{Oct 2022~--~On}{Data Science Bootcamp Online}{%
        from \href{https://codigofacilito.com/programas/ciencia-datos}{Código Facilito}
    }
...
\begin{cventries}
    \singleline{2022}{%
        ...
        \href{https://codigofacilito.com/cursos/base-datos-profesional}{Código
        Facilito}
    }
...
\begin{cventries}
    \skill{Programming}{Python (\numpy{}, \pandas{}, \scipy{}, \xarray{},
        \matplotlib{}, \plotly{}, \dash{}, \pygmt{}), Numba, bash, FORTRAN,
        C, SQL
    }
