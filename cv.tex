...
\experience{Nov 2021 -- on}{Coding Coordinator and Trainer}{\coco}{%
    ...
    \begin{lista}
        \item {\bf Collaborated} in different tasks to create a good
            foundation for 10-week program to teach how to code in Python and
            science communication.
        \item {\bf Managed and supervised} the team of 5+ coding trainers to teach
            coding to 20 bilingual students.
            Students proved basic coding proficiency and communication skills.
        \item {\bf Organized and supervised} a 1-week hackathon where
            participants developed a shared project using version control
            system, python programming and communication of the achieved goals
            and results.
        \item {\bf Created and maintained} a
        \href{https://github.com/CodeToCommunicate/CoCoLessons}{GitHub repository}
            with the course material, primarily Jupyter Notebooks, to teach in
            each lessons about Python and
            \href{https://github.com/CodeToCommunicate/gitLesson}{Git}.
    \end{lista}
}

\experience{Apr 2019 -- Mar 2022}{Postdoctoral Researcher}{\igsv, Argentina}{%
    {\it Project title: Influence of a mantle plume in subduction zones by
    geodynamics numerical models.}
    \begin{lista}
        \item {\bf Developed} pipeline to create a subduction model, run the
            simulation using \mandyoc and plot the results using Xarray, NumPy
            and Matplotlib.
        \item {\bf Built} a
...
\experience{Apr 2014 -- Mar 2019}{PhD Researcher}{\igsv, Argentina \newline
    {\it Thesis title: \href{https://ri.conicet.gov.ar/handle/11336/84580}{Análisis
