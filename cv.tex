...
I am a PhD in Geophysics with a strong formation in Physics, Mathematics,
Software Development and scientific research.
I have experience collecting, cleaning, processing and visualizing real data
with the goal to understand the inner structure of the Earth and analyze its
processes using different
Python libraries like \pandas{}, \scipy{}, \numpy{}, \xarray{}, \matplotlib{}
and \plotly{} among others.
I feel very comfortable at working with command line interfaces, Unix and Linux
OSs, version-control systems, GitHub workflows and I'm always eager to apply
best practices for software development.

\vspace{\entriespad}

I'm a quick learner who enjoys solving challenging problems in creative ways.
I love to learn new tools and improve my Computer Sciences skills to better
analyze data and find the best way to communicate results.
I'm currently looking for a Data Scientist position to integrate all my
knowledge into the IT industry.

I am looking for a Data Scientist position to integrate all my knowledge into
the IT industry.

PhD in Geophysics who's leaving Academia to pursuit a career in IT as Data
Scientist. Skilled professional with almost a decade of experience in
collecting, cleaning, processing and visualizing real geoscientific data.
Experienced programmer in Python and Linux user who relies on version-control
systems on daily basis and a loves to learn new tools and best practices for
software development.
Also a quick learner who enjoys solving challenging problems in creative ways
