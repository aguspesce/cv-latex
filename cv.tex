...
\service{Member of \geolatinas{} community}{Support the community by
        giving Python and Git courses, developing the coding group website
        and advising other members on programming.}
\service{Member of the \carpentries{} community}{Contribute to the
