...
\newcommand{\website}{www.aguspesce.github.io}
...
\newcommand{\LINKEDIN}[1]{\href{https://linkeding.com/#1}{linkedin.com/#1}}
...
\begin{minipage}[t]{0.60\linewidth}
    \begin{flushleft}
        \textbf{Address:} Vancouver, Canada
        \\
...
I have a degree in Psychics and a Phd in Gepphysics.
...
\begin{cventries}
    \multiline{2014 - 2019}{PhD in Geophysics}{\fcefn, \unsj, Argentina.}
    \multiline{2005 - 2014}{Licentiate in Physics}{\fceia, \unr, Argentina.}
\end{cventries}
...
\begin{cventries}
    ...
    \talk{2020}{\href{https://doi.org/10.5194/egusphere-egu2020-734}{valuation
